        ...
        <div className="mw8 center center ph2 center">
            <div className="dt tc center mb4 mw7 mw7-ns shadow-5 bg-near-white navy br1">
                <div className="dib w-50 tcl mb1 ph3">
                    ...
                    <a className="dim db f5 near-black">imslab@imslab.org</a>
                    <br />
                </div>
                <div className="dib w-50 tcl mb1 ph3">
            ...
            <div className="mt2 w-100 center">
                <iframe
                    width="100%"
                    height="400px"
                    src="https://maps.google.com/maps?width=100%&amp;height=400&amp;hl=zh-TW&amp;coord=22.997143,120.221371&amp;q=22.997143,120.221371&amp;SameSite=Lax;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"
                />
            </div>
        </div>
    );
